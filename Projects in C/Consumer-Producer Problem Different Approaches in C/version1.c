...
int main(int argc, const char * argv[]) {
    ...
    printf("How many times should producers save data into the buffer? \n");
    scanf ("%d", &numActions);
    
    //if a wrong number of actions was entered
    while (numActions <=0) {
        printf("Please enter a correct number of actions (>= 1): \n");
        scanf ("%d", &numActions);
    }
